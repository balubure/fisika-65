import { useGLTF, OrbitControls, DragControls } from '@react-three/drei'
...
export default function Experience()
{
    ...
    */
    useFrame((state) =>
    {
        ...
        const eulerRotation = new THREE.Euler(0, time * 0.0003, 0)
    ...
    const cubeJump = () =>
    {
       ...
       // cube.current.applyImpulse({ x: 0, y: 5 * mass, z: 0 })
        cube.current.addForce({ x: 0, y: 2 * mass, z: 0 })
